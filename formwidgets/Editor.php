...
class Editor extends FormWidgetBase
{
    ...
    public function prepareVars()
    {
        ...
        $this->vars['toolbar_froala_lg'] = (empty(Settings::instance()->toolbar_froala_lg)) ? "'undo', 'redo', 'clearFormatting', 'html', '|', 'bold', 'italic', 'underline', 'strikeThrough', '|', 'paragraphFormat', 'align', 'fontSize', 'color', '|', 'formatUL', 'formatOL', 'outdent', 'indent', '|', 'insertLink', 'insertImage', 'insertVideo', 'insertFile', 'insertTable', '|', 'fullscreen'" : Settings::instance()->toolbar_froala_lg;

        $this->vars['toolbar_froala_md'] = (empty(Settings::instance()->toolbar_froala_md)) ? "'undo', 'clearFormatting', 'html', '|', 'bold', 'italic', 'underline', '|', 'paragraphFormat', 'align', 'fontSize', 'color', '|', 'formatUL', 'formatOL', 'outdent', 'indent', '|', 'insertLink', 'insertImage', 'insertVideo', 'insertFile', 'insertTable', '|', 'fullscreen'" : Settings::instance()->toolbar_froala_md;

        $this->vars['toolbar_froala_sm'] = (empty(Settings::instance()->toolbar_froala_sm)) ? "'undo', 'html', '|', 'bold', 'italic', 'underline', '|', 'paragraphFormat', 'align', 'fontSize', 'color', '|', 'formatUL', 'formatOL', 'outdent', 'indent', '|', 'insertLink', 'insertImage', 'insertFile', 'insertTable', '|', 'fullscreen'" : Settings::instance()->toolbar_froala_sm;
